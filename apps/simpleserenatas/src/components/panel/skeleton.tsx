...
export function SkeletonCard({ className = '' }: { className?: string }) {
    return (
        <div
            className={`panel-surface-card rounded-card border p-4 ${className}`}
        >
...
export function SkeletonRow({ className = '' }: { className?: string }) {
    return (
        <div
            className={`panel-surface-card rounded-card border p-4 flex items-center gap-3 ${className}`}
        >
...
export function SkeletonStat({ className = '' }: { className?: string }) {
    return (
        <div
            className={`panel-surface-card p-4 rounded-card border ${className}`}
        >
