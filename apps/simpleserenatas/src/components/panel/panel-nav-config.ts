...
const PANEL_NAV_ITEMS: PanelNavItem[] = [
    { href: '/panel', label: 'Mi Panel', icon: IconConfetti },
    { href: '/panel/eventos', label: 'Eventos', icon: IconFileText },
    { href: '/panel/nuevo-evento', label: 'Nuevo evento', icon: IconPlus },
    ...
    { href: '/panel/musica', label: 'Música', icon: IconMusic },
