...
const CHOICES: Choice[] = [
    ...
    },
    {
        ...
        destination: '/panel/cuenta?account_tab=musico',
    },
    {
        key: 'owner',
        title: 'Soy dueño',
        description: 'Quiero registrar mi grupo de mariachi y recibir solicitudes.',
        icon: IconUsersGroup,
        benefits: ['Publicar mi grupo', 'Configurar servicios y precios', 'Administrar solicitudes y disponibilidad'],
