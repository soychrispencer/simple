...
import { SerenatasNotificationBadgeProvider } from '@/context/SerenatasNotificationBadgeContext';
import { SerenatasPushSetup } from '@/components/SerenatasPushSetup';
...
export default function AppLayout({
    ...
    return (
        <SerenatasNotificationBadgeProvider>
            <SerenatasPushSetup />
