...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section className="w-full px-4 py-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="type-title-1 text-lighttext dark:text-darktext mb-4">
              Explora por Categoría
            </h2>
            <p className="type-body-md text-lighttext/60 dark:text-darktext/60 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="type-title-3 text-lighttext dark:text-darktext mb-2 group-hover:text-primary transition-colors">
                  Casas
                </h3>
      ...
      <section className="w-full px-4 py-16">
        <div className="max-w-7xl mx-auto">
          <h2 className="type-title-1 text-lighttext dark:text-darktext mb-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="type-title-3 mb-2 text-lighttext dark:text-darktext">Simple</h3>
            ...
            <div className="text-center">
              <div className="text-5xl mb-4">⚡</div>
              <h3 className="type-title-3 mb-2 text-lighttext dark:text-darktext">Rápido</h3>
              <p className="type-body-md text-lighttext/70 dark:text-darktext/70">
            ...
            <div className="text-center">
              <div className="text-5xl mb-4">🔒</div>
              <h3 className="type-title-3 mb-2 text-lighttext dark:text-darktext">Seguro</h3>
              <p className="type-body-md text-lighttext/70 dark:text-darktext/70">
