            ...
            <div className="border-b bg-[var(--bg)] border-[var(--border)]">
                <div className="max-w-4xl mx-auto px-4 py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <p className="text-[10px] text-[var(--fg-muted)]">Gratis · sin registro</p>
                    </div>
                ...
                <div className="grid gap-6 lg:grid-cols-5">
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="p-4 rounded-xl border border-[var(--border)]">
                            ...
                            <div className="mt-3 p-3 rounded-lg border border-[var(--border)] space-y-1">
                            ...
                            <>
                                ...
                                <div className="rounded-xl border border-[var(--border)]">
                                    ...
                                    <div className="px-4 pb-3">
                                        ...
                                        <div className="flex justify-center p-1 rounded-lg bg-[var(--bg-subtle)]">
                                            <button
                                                onClick={()=>setScenarioTab('recommended')}
                                                className={`flex-1 px-4 py-2 rounded-button text-[11px] font-semibold transition-all duration-200 ${scenarioTab==='recommended'? 'bg-[var(--accent)] text-white shadow-sm' : 'text-[var(--fg-muted)] hover:text-[var(--fg)] hover:bg-[var(--bg)]'}`}
                                            >
                                                Recomendado
                                            </button>
                                            <button
                                                onClick={()=>setScenarioTab('limit')}
                                                className={`flex-1 px-4 py-2 rounded-button text-[11px] font-semibold transition-all duration-200 ${scenarioTab==='limit'? 'bg-[var(--fg)] text-white shadow-sm' : 'text-[var(--fg-muted)] hover:text-[var(--fg)] hover:bg-[var(--bg)]'}`}
                                            >
                                ...
                                <button onClick={handleReset} className="btn btn-outline w-full py-2.5 px-4 flex items-center justify-center">
                                    <IconRotate size={18} className="mr-2"/>
                                    Nueva simulación
                                </button>
                                <div className="mt-3">
