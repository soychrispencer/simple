...
import { usePropiedadesBusinessSetup } from '@/hooks/use-business-setup';
...
export default function PanelHomePage() {
    ...
    const businessSetup = usePropiedadesBusinessSetup();
            ...
            <div className="grid gap-4">
                ...
                <div className="grid gap-4 lg:grid-cols-2">
                    <PanelCard size="md">
                        ...
                        />
                        {loading ? (
                            <div className="h-28 rounded-2xl animate-pulse" style={{ background: 'var(--bg-muted)' }} />
                        ) : activeItems.length === 0 ? (
                            <div className="space-y-3">
                                <PanelNotice tone="neutral">Aún no tienes publicaciones activas.</PanelNotice>
                                <Link href="/panel/publicar">
                                    <PanelButton type="button" className="w-full">Publicar mi primera propiedad</PanelButton>
                                </Link>
                            </div>
                        ) : (
                    ...
                    <PanelCard size="md">
                        ...
                        {loading ? (
                            <div className="h-24 rounded-2xl animate-pulse" style={{ background: 'var(--bg-muted)' }} />
                        ) : items.length === 0 ? (
                            <div className="space-y-3">
