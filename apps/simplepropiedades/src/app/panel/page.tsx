      ...
      <div className="card-surface shadow-card p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" onClick={() => router.push("/panel/publicaciones")}>Ver publicaciones</Button>
            <Button variant="primary" size="sm" onClick={() => router.push("/panel/nueva-publicacion")}>Publicar</Button>
          </div>
        </div>
