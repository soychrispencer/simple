...
import { IconBuildingCommunity, IconUsersGroup, IconCircleCheck } from "@tabler/icons-react";
...
export default function EmpresaPage() {
  ...
  return (
    <PanelPageLayout
      header={{
        title: "Mi Negocio",
        description: "Gestiona los datos legales, contactos y facturación de tu negocio inmobiliario.",
      }}
    >
