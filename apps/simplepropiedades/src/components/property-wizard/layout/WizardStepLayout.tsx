      ...
      <header className={cn("flex flex-col gap-3 sm:gap-4", headerAlign)}>
        ...
        <div className="flex w-full items-start justify-between gap-6">
          <div className={cn("flex flex-col gap-3 flex-1", align === "center" ? "items-center" : "")}>
            ...
            {description ? (
              <p className="type-body-md sm:text-lg text-lighttext/70 dark:text-darktext/70">{description}</p>
            ) : null}
            ...
            {summary ? (
              <div className="type-caption text-lighttext/60 dark:text-darktext/60">{summary}</div>
            ) : null}
          </div>
