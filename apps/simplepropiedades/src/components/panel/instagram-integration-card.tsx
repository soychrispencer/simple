...
export default function InstagramIntegrationCard() {
    ...
    return (
        <PanelCard size="lg">
            <PanelBlockHeader
                title="Instagram"
                description="Conecta una cuenta profesional y publica propiedades directamente desde SimplePropiedades."
                className="mb-4"
            />
                    ...
                    <div className="rounded-2xl border p-5 space-y-4" style={{ borderColor: 'var(--border)', background: 'var(--bg-subtle)' }}>
                        <div className="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p className="text-sm" style={{ color: 'var(--fg-secondary)' }}>
                                    Cuando una propiedad quede activa, SimplePropiedades intentará publicarla automáticamente en Instagram.
                                </p>
                            </div>
                            <PanelSwitch checked={autoPublishEnabled} onChange={setAutoPublishEnabled} ariaLabel="Autopublicar propiedades en Instagram" />
                        </div>
