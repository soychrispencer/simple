...
// Normaliza un VehicleRow a Vehicle
...
export default function VentasPage() {
  ...
  const demoRows = useMemo(() => {
    if (!showDemo) return [];
    return getDemoVehicleRows({ count: 50, includeFeaturedMix: true }).filter(r => r.listing_type === 'sale');
  }, [showDemo]);
      ...
      <div className="flex flex-col md:flex-row gap-6 w-full pb-8">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline justify-between mb-4 gap-4 flex-wrap">
            <h1 className="text-2xl font-bold">Vehículos en venta</h1>
