...
const runtimePublicEnv = {
  ...
  NEXT_PUBLIC_SIMPLE_API_BASE_URL: process.env.NEXT_PUBLIC_SIMPLE_API_BASE_URL || "",
  NEXT_PUBLIC_ENABLE_SIMPLE_API_LISTINGS: process.env.NEXT_PUBLIC_ENABLE_SIMPLE_API_LISTINGS || "",
  NEXT_PUBLIC_ENABLE_SIMPLE_API_WRITES: process.env.NEXT_PUBLIC_ENABLE_SIMPLE_API_WRITES || "",
  NEXT_PUBLIC_SIMPLE_API_STRICT_WRITES: process.env.NEXT_PUBLIC_SIMPLE_API_STRICT_WRITES || "",
};
