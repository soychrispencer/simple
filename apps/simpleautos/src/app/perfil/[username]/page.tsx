...
import { PanelBlockHeader, PanelCard, PanelNotice, PanelStatusBadge, PanelStatCard } from '@simple/ui';
...
export default function PublicProfilePage() {
    ...
    const initials = initialsFromName(profile?.name ?? 'SA');
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1.35fr)_360px]">
                <div className="space-y-6">
                    ...
                    {profile.teamMembers.length > 0 ? (
                        <PanelCard size="lg" className="space-y-5">
                            <PanelBlockHeader title="Equipo comercial" description="Asesores o vendedores visibles conectados a esta cuenta y a su operación pública." className="mb-0" />
                            <div className="grid gap-4 md:grid-cols-2">
