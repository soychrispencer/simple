        ...
        return (
            <div className="container-app py-8">
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
                    <div className="h-[420px] rounded-[32px] animate-pulse" style={{ background: 'var(--bg-muted)' }} />
                    <div className="h-72 rounded-[32px] animate-pulse" style={{ background: 'var(--bg-muted)' }} />
                </div>
            </div>
        );
    }
