...
export default function Forgot() {
  ...
  return (
    <div className="max-w-md mx-auto my-10 card-surface shadow-card rounded-2xl p-6">
      ...
      <p className="text-sm text-lighttext/80 dark:text-darktext/80 mb-4">Ingresa tu correo y te enviaremos un enlace para restablecer tu contrasena.</p>
      ...
      {ok && (
        <div className="mt-4 text-sm text-[var(--color-success)] bg-[var(--color-success-subtle-bg)] border border-[var(--color-success-subtle-border)] p-3 rounded-lg">
          Si el correo existe, recibirás un enlace para restablecer tu contrasena.
          {debugResetUrl ? (
