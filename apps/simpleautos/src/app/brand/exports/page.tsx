          ...
          {brands.map((b) => (
            <section key={b.key} className="card-surface shadow-card p-4 flex flex-col md:flex-row md:items-center gap-4">
              <div className="flex items-center gap-4 min-w-0">
                <div
                  className="flex items-center justify-center w-24 h-24 rounded-full shadow-card ring-2 ring-[color:var(--overlay-highlight-80)] ring-offset-2 ring-offset-transparent"
