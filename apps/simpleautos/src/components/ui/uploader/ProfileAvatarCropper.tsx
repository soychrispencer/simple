		...
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--overlay-scrim-80)] backdrop-blur-sm">
			<div className="card-surface card-surface-raised rounded-3xl shadow-card p-0 w-full max-w-4xl flex flex-col items-center animate-fadein">
				...
				<div className="w-full flex flex-row items-center justify-between px-8 pt-8 pb-4">
					...
					<button
						onClick={onClose}
						className="w-8 h-8 rounded-full bg-[var(--field-bg)] border border-[var(--field-border)] hover:bg-[var(--field-bg-hover)] flex items-center justify-center transition-colors group"
					>
					...
					<div className="w-full lg:w-80 flex flex-col items-center gap-4">
						...
						<div className="relative w-full max-w-sm">
								...
								<div className="relative px-6 pt-6 pb-4">
									...
									<div className="text-center">
										<div className="h-4 bg-[var(--field-bg)] border border-[var(--field-border)] rounded mb-2 w-3/4 mx-auto"></div>
										<div className="h-3 bg-[var(--field-bg)] border border-[var(--field-border)] rounded w-1/2 mx-auto"></div>
									</div>
								</div>
							</div>
				...
				<div className="flex flex-row gap-3 w-full px-8 pb-8 justify-end">
					...
					<Button
						...
						className="px-6 py-2.5 rounded-xl font-medium bg-primary hover:bg-[var(--color-primary-a90)] shadow-token-sm"
					>
