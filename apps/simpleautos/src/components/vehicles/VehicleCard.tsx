        ...
        <div className="flex flex-row items-stretch gap-0">
          ...
          <div className="relative w-40 sm:w-72 flex-shrink-0 card-surface/90 shadow-card rounded-l-2xl overflow-hidden">
            <div className="relative w-full h-full aspect-[4/3] overflow-hidden">
              ...
              {discountInfo ? (
                <span className="absolute top-3 right-3 z-20 text-[11px] font-semibold px-2.5 py-1.5 rounded-md border bg-primary text-[var(--color-on-primary)] border-[var(--color-primary-a90)] shadow-card select-none">
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full aspect-[16/10] overflow-hidden card-surface/90 shadow-card">
        ...
        {discountInfo ? (
          <span className="absolute top-2 right-2 z-30 text-[11px] font-semibold px-2.5 py-1.5 rounded-md border bg-primary text-[var(--color-on-primary)] border-[var(--color-primary-a90)] shadow-card select-none">
            {discountInfo.badgeText}
          </span>
        ) : null}
      </div>
