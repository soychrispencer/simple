...
const FEATURED_SERVICE_CATEGORIES = ['maintenance', 'car_wash', 'mechanics', 'rt', 'tow'] as const;
const FEATURED_PRODUCT_CATEGORIES = ['protection', 'stickers', 'interior', 'exterior'] as const;

export function AutomotiveHubSection() {
    const serviceCategories = getOperatorServiceCategories('autos');
    const productCategories = getOperatorProductCategories('autos');

    return (
        <section className="container-app section-marketing">
            <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div className="max-w-2xl space-y-2">
                    <p className="text-sm font-medium text-fg-muted">Todo para tu auto</p>
                    <h2 className="text-2xl font-semibold text-fg md:text-3xl">Servicios y productos cerca de ti</h2>
                    <p className="text-base text-fg-secondary">
                        Mantención, lavado, accesorios y más — de negocios verificados en SimpleAutos.
                    </p>
                </div>
            ...
            <div className="grid gap-4 lg:grid-cols-2">
                <PanelCard size="lg" className="space-y-4 p-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-semibold text-fg">Servicios automotrices</h3>
                            <p className="text-sm text-fg-muted">Talleres, lavados, RT y asistencia</p>
                        </div>
                    </div>
                    <div className="flex flex-wrap gap-2">
                ...
                <PanelCard size="lg" className="space-y-4 p-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-semibold text-fg">Productos y accesorios</h3>
                            <p className="text-sm text-fg-muted">Zócalos, stickers, protectores y más</p>
                        </div>
                    </div>
                    <div className="flex flex-wrap gap-2">
