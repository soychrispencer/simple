...
export function SellerProductsCrossSell({
    ...
    return (
        <PanelCard size="lg" className="space-y-4 p-4 md:p-6">
            <PanelBlockHeader
                title="Accesorios de este vendedor"
                description={`Productos que ${sellerName} ofrece en su tienda.`}
                className="mb-0"
                actions={profileHref ? (
            ...
            />
            <BusinessOperatorProductsCatalog vertical="autos" products={products} showConsult={false} />
        </PanelCard>
    );
}
