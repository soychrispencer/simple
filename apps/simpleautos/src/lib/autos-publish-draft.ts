...
export function mergeAutosPublishDraft(raw: unknown): { form: PublishFormData; step: AutosPublishStep } | null {
    ...
    const form: PublishFormData = {
        ...
        catalogPromoPrice: typeof data.catalogPromoPrice === 'string' ? data.catalogPromoPrice : '',
        serviceDurationMinutes: typeof data.serviceDurationMinutes === 'string' ? data.serviceDurationMinutes : '',
        serviceIsOnline: !!data.serviceIsOnline,
        serviceIsPresential: data.serviceIsPresential !== false,
        productStock: typeof data.productStock === 'string' ? data.productStock : '',
        productSku: typeof data.productSku === 'string' ? data.productSku : '',
