                ...
                <div className="flex flex-col gap-4">
                    ...
                    <PanelCard size="md">
                        <div className="flex items-start justify-between gap-4 flex-wrap">
                            <div>
                                <h2 className="text-sm font-semibold" style={{ color: 'var(--fg)' }}>Estilo de la página</h2>
                                <p className="text-xs mt-1" style={{ color: 'var(--fg-muted)' }}>
                                    Elige entre Reserva, Portafolio o Estudio y el modo claro/oscuro.
                                </p>
                            </div>
                            <Link
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                >
                                    ...
                                    <p className="text-xs" style={{ color: 'var(--fg-muted)' }}>
                                        Cuando esté disponible, <strong style={{ color: 'var(--fg)' }}>Dominio personalizado</strong> será parte del plan Pro.
                                    </p>
                                </div>
