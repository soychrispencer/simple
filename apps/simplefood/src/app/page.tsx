    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="w-full px-4 md:px-8 lg:px-8 pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {metrics.map((metric) => (
            ...
            >
              <p className="type-kpi text-primary">{metric.value}</p>
              <p className="type-body-sm text-lighttext/70 dark:text-darktext/70">{metric.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="w-full px-4 md:px-8 lg:px-8 pb-12">
        <div className="rounded-3xl card-surface shadow-card p-6 flex flex-col gap-3">
          <div className="flex flex-wrap gap-3 justify-between type-body-sm text-lighttext/70 dark:text-darktext/70">
          ...
          <p className="type-body-md text-lighttext dark:text-darktext">
      ...
      <section className="w-full px-4 md:px-8 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="rounded-3xl card-surface shadow-card p-8 space-y-4">
            <h2 className="type-title-1 text-lighttext dark:text-darktext">Operaciones conectadas</h2>
            ...
            <ul className="space-y-2 type-body-sm text-lighttext/80 dark:text-darktext/80">
          ...
          <div className="rounded-3xl card-surface shadow-card ring-1 ring-border/60 p-8 space-y-4">
            <h2 className="type-title-1 text-lighttext dark:text-darktext">Campañas y experiencias</h2>
            <p className="type-body-md text-lighttext/70 dark:text-darktext/70">
