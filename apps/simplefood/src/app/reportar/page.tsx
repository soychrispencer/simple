...
export const metadata: Metadata = {
  ...
  description: "Reporta un problema de seguridad o funcionamiento en SimpleFood.",
};
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <p className="mt-3 text-sm text-lighttext/80 dark:text-darktext/80">
        Si algo no funciona o detectas un caso de seguridad, repórtalo.
      </p>
      ...
      <section className="mt-6 card-surface shadow-card p-6 space-y-5">
        <div className="text-sm text-lighttext/80 dark:text-darktext/80 leading-relaxed">
          ...
          <ul className="mt-2 list-disc pl-5 space-y-2">
            <li>Qué estabas haciendo y qué ocurrió</li>
            <li>Si es posible, una captura de pantalla</li>
            <li>Link o sección donde pasó el problema</li>
          </ul>
        </div>
