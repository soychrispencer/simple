        ...
        <div className="flex min-h-screen w-full flex-col" style={{ background: 'var(--bg)' }}>
            <header className="relative z-40 transition-all duration-300" style={{ borderBottom: '1px solid var(--border)' }}>
                <div className="container-app flex items-center justify-between h-16">
                    <Link href={withAdminScope('/', scope)} className="flex items-center gap-1.5 group shrink-0">
                        <IconShieldLock size={20} style={{ color: '#4f46e5' }} />
                        <span className="inline-flex items-baseline gap-[0.08rem] text-lg tracking-tight" style={{ color: '#4f46e5' }}>
                            <span className="font-semibold leading-none">Simple</span>
                            <span className="font-normal leading-none">Admin</span>
                        </span>
                    </Link>
