...
export const MARKETPLACE_ADVERTISING_CONFIG: Record<AdvertisingVertical, VerticalAdvertisingConfig> = {
    ...
    propiedades: {
        ...
        copy: {
            pageTitle: 'Publicidad',
            pageDescription: 'Gestiona campañas promocionales y boosts de publicaciones desde una sola sección.',
            boostTabLabel: 'Boost de avisos',
            campaignsTabLabel: 'Campañas',
            boostActivateTitle: 'Activar boost',
            boostActivateDescription: 'Destaca una publicación en la sección correspondiente del home y listados.',
            boostTargetLabel: 'Publicación',
            boostEmptyTargets: 'No tienes publicaciones activas para impulsar.',
            boostEmptyTargetsLink: '/panel/publicar',
            profileDestinationLabel: 'Perfil público',
        },
    },
