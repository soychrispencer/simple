...
const SIMPLE_APP_BRANDS: Record<SimpleAppId, SimpleAppBrand> = {
    ...
    simpleagenda: {
        ...
        title: 'SimpleAgenda | Agenda online y sistema de reservas',
        description: 'Agenda online para reservas, citas, clientes y pagos. SimpleAgenda ayuda a profesionales, barberías, estética, salud privada y servicios a recibir reservas online.',
        category: 'business',
        siteUrl: 'https://simpleagenda.app',
        keywords: [
            'SimpleAgenda',
            'agenda online',
            'agenda digital',
