 ...
 * 
 * Uso:
 *   node scripts/archive/seed-superadmin.mjs <email> <password> <name> [api-url]
 * 
 * Ejemplo:
...
if (!email || !password) {
    ...
    console.error('Uso: node scripts/archive/seed-superadmin.mjs <email> <password> [name] [api-url]');
    process.exit(1);
}
