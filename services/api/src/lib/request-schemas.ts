...
const boostTargetTypeSchema = z.enum(['listing', 'serenata_group', 'operator_profile', 'operator_product', 'operator_service']);
const boostSectionSchema = z.enum(['sale', 'rent', 'auction', 'project', 'marketplace', 'landing', 'products', 'services']);
