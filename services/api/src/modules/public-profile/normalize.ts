...
export type { PublicProfileSocialLinks, PublicProfileTeamSocialLinks, PublicProfileBusinessHour };
...
export function createDefaultPublicProfileTeamSocialLinks(): PublicProfileTeamSocialLinks {
    return {
        instagram: null,
        facebook: null,
        linkedin: null,
...
export function normalizePublicProfileTeamSocialLinks(value: unknown): PublicProfileTeamSocialLinks {
    const source = value && typeof value === 'object' ? value as Record<string, unknown> : {};
...
export function normalizePublicProfileTeamMemberSpecialties(value: unknown): string[] {
