...
export const SUBSCRIPTION_PLANS_BY_VERTICAL: Record<VerticalType, SubscriptionPlanRecord[]> = {
    ...
    agenda: [
        ...
        },
        {
            id: 'essential',
            name: 'Esencial',
            description: 'Tu agenda online activa para recibir reservas sin comisión.',
            priceMonthly: 9990,
            currency: 'CLP',
            maxListings: 0,
            maxFeaturedListings: 0,
            ...
            apiAccess: false,
            maxFreeBoostsPerMonth: 0,
            features: ['Perfil público activo', 'Marketplace y link de reservas', 'Servicios y agenda básica', 'Reservas y clientes básicos', 'Notificaciones básicas', 'Sin comisión por reserva'],
        },
        {
            id: 'pro',
            name: 'Pro',
            ...
            maxFreeBoostsPerMonth: 0,
            recommended: true,
            features: ['Todo lo del Esencial', 'Agenda avanzada', 'Clientes, historial y notas', 'Pagos, packs y promociones', 'Recordatorios avanzados', 'Reportes, NPS y referidos', 'Automatización y múltiples ubicaciones', 'Sin comisión por reserva'],
        },
    ],
    serenatas: [
        {
        ...
        },
        {
            id: 'essential',
            name: 'Esencial',
            description: 'Tu vitrina profesional activa, sin comisión por serenata.',
            priceMonthly: 9990,
            currency: 'CLP',
            maxListings: 0,
            maxFeaturedListings: 0,
            ...
            apiAccess: false,
            maxFreeBoostsPerMonth: 0,
            features: ['Perfil público activo', 'Marketplace y WhatsApp visible', 'Hasta 3 servicios activos', 'Repertorio básico', 'Solicitudes y agenda básica', 'Sin comisión por serenata'],
        },
        {
            id: 'pro',
            name: 'Pro',
            ...
            maxFreeBoostsPerMonth: 0,
            recommended: true,
            features: ['Todo lo del Esencial', 'Servicios y repertorio completos', 'Solicitudes y agenda avanzada', 'Invitaciones y gestión de músicos', 'Finanzas y pagos a músicos', 'Chat WhatsApp desde panel', 'Mapa y rutas', 'Mayor visibilidad', 'Sin comisión por serenata'],
        },
    ],
    plataforma: [
        {
