...
if (parsed.data.NODE_ENV === 'production' && parsed.data.SESSION_SECRET === 'simple_local_dev_secret_change_me') {
    throw new Error('[simple-api] SESSION_SECRET is the default dev value — change it before production');
}
