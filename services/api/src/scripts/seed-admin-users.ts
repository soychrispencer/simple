 ...
 *
 * Run:  npx tsx src/scripts/seed-admin-users.ts
...
import { users, accounts, accountUsers } from '../db/schema.js';
...
const ADMIN_ACCOUNTS: AdminDef[] = [
    ...
    {
        email: 'admin@simpleserenatas.app',
        name: 'Admin SimpleSerenatas',
        role: 'admin',
        primaryVertical: 'serenatas',
    },
];
