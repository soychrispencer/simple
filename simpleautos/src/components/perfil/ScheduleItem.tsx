...
export function ScheduleItem({ label, range, cerrado, especial, dateRaw, is247 }: ScheduleItemProps) {
  return (
    <div className="flex items-center gap-3 px-3 py-2 rounded-lg border border-lightborder/20 dark:border-darkborder/20 bg-lightbg dark:bg-darkbg backdrop-blur-sm text-sm transition-base">
      ...
      <span className="flex-1 text-lighttext dark:text-darktext">
        {cerrado ? (
          ...
          <span className="text-green-600 dark:text-green-400 font-medium">Abierto</span>
        ) : (
      ...
      <span className="flex items-center gap-2">
        {especial && <Chip variant="warning" size="sm">Especial</Chip>}
