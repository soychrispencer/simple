...
export default function ProfileAvatarCropper({ open, imageSrc, onClose, onCropped }: ProfileAvatarCropperProps) {
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
			<div className="bg-white dark:bg-darkcard rounded-3xl shadow-2xl p-0 w-full max-w-4xl flex flex-col items-center animate-fadein border border-gray-200/20 dark:border-gray-700/20">
				{/* Header */}
				<div className="w-full flex flex-row items-center justify-between px-8 pt-8 pb-4">
					<div>
						<h2 className="font-bold text-2xl text-gray-900 dark:text-white">Recortar avatar</h2>
						...
						<div className="relative w-full max-w-sm">
							<div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
								...
								<div className="relative px-6 pt-6 pb-4">
									...
									<div className="text-center">
										<div className="h-4 bg-gray-300 dark:bg-gray-600 rounded mb-2 w-3/4 mx-auto"></div>
