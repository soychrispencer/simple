...
// Endpoint mantenido únicamente para flujos de confirmación por correo.
// El registro estándar ocurre en el cliente usando Supabase Auth (signUp) dentro del nuevo AuthContext.
...
export async function POST(req: NextRequest) {
  ...
  const redirectTo = "http://localhost:3000/auth/confirm"; // Ajustar dominio en producción
