...
export default function SubastasPage() {
  ...
  const { filters, update, setPage, normalizedForQuery } = useListingFilters('subasta');
  ...
  <div className="w-full px-4 md:px-8 lg:px-8">
    <div className="flex flex-col md:flex-row gap-8 max-w-[1400px] mx-auto pb-8">
      ...
      <div className="flex-1 min-w-0">
        {/* Slider de vehículos impulsados en subastas */}
        <CategoryFeaturedSlider listingType="auction" limit={4} slidesPerView={4} />
        ...
        {!loading && vehicles.length === 0 ? (
          <div className="text-center py-16 border border-dashed rounded-xl dark:border-white/10 border-black/10">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">No hay subastas que coincidan. Ajusta los filtros.</p>
          </div>
        ) : loading ? (
