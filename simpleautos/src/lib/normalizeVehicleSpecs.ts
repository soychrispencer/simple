/**
 * Normaliza las especificaciones del vehículo para mostrar en tarjetas
 * Busca en múltiples ubicaciones posibles y retorna valores consistentes
 */
...
export function normalizeVehicleSpecs(vehicle: any) {
  ...
  return {
    ...
    // Transmisión: buscar en todos los lugares posibles
    transmission: 
    ...
    // Tipo de carrocería: buscar en todos los lugares posibles
    bodyType: 
      vehicle.body_type || 
