...
**Ubicación:** [services/api/src/index.ts](services/api/src/index.ts#L3661)
...
**Ubicación:** [services/api/src/index.ts](services/api/src/index.ts#L608-616)
...
**Ubicación:** [services/api/src/index.ts](services/api/src/index.ts#L396)
...
### FORMULARIO REGISTRO
**Ubicación:** [apps/simpleautos/src/components/auth/auth-modal.tsx](apps/simpleautos/src/components/auth/auth-modal.tsx#L117)
...
### SCHEMA REGISTRO
**Ubicación:** [services/api/src/index.ts](services/api/src/index.ts#L403-408)
...
**Ubicación:** [services/api/src/index.ts](services/api/src/index.ts#L3678-3681)
...
**Ubicación:** [apps/simpleautos/src/components/auth/auth-modal.tsx](apps/simpleautos/src/components/auth/auth-modal.tsx#L193-210)
...
**Ubicación:** [services/api/src/index.ts](services/api/src/index.ts#L3569-3595)
